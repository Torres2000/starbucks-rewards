    ...
    <>
      <nav>
        <section className="max-w-[1440px] m-auto flex justify-between lg:h-[6.2rem] lg:px-10 lg:gap-12 2xl:px-0">
          ...
          <section
            className={`h-[calc(100%-64px)]  bottom-auto fixed z-20 w-full bg-black/35  sm:h-[calc(100%-83px)] top-[73px] block md:top-[83px] lg:bg-white lg:relative lg:top-0 lg:h-full ${
